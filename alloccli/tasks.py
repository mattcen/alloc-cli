...
class tasks(alloc):
    ...
    ops.append(
        (
            "a:",
            "assignee=NAME  ",
            "A task's assignee, username or first and surname.\n"
            '(eg: "jon" eg: "all" eg: "NULL". Defaults to yourself.)',
        )
    )
    ops.append(
        ("m:", "manager=NAME   ", "A task's manager, username or first and surname\".")
    )
    ops.append(
        ("c:", "creator=NAME   ", "A task's creator, username or first and surname\".")
    )
    ops.append(
        (
            "o:",
            "order=NAME     ",
            "The order the Tasks are displayed in.\n"
    ...
    def run(self, command_list):
        ...
        if not o["fields"]:
            if not order:
                order = ["priorityLabel", "taskTypeID", "_rate", "taskStatusLabel"]
            fields = [
                "taskID",
                "taskTypeID",
                "taskStatusLabel",
